            ...
            <div>
              ...
              >
                ...
                <p className="lg:text-xl text-lg font-roboto text-gray-300 leading-9">
                  ...
                  quidem minima nostrum quis voluptatem atque ducimus nobis
                  sapiente voluptatum recusandae odio necessitatibus illum esse,
                  doloribus sed debitis voluptatibus. Obcaecati, facere?
                </p>
              </div>
              {/* {Designers Section} */}
              <div className="flex flex-col justify-center items-center">
                ...
                <div className="flex lg:justify-center lg:flex-row flex-col items-center gap-8 lg:mx-0 mx-10">
                  <div
              ...
              {/* {Developer Section} */}
              <div className="flex flex-col justify-center items-center py-20 lg:mx-0 mx-10">
                <div>
                  <h1 className="lg:text-4xl text-2xl font-bold font-roboto text-gray-600 capitalize py-4">
                    meet our developers
                  </h1>
