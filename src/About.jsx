        ...
        <div className="flex justify-center lg:flex-row flex-col items-center my-24 overflow-x-hidden">
          ...
          >
            ...
            <p className="lg:text-xl text-lg font-roboto leading-8 text-gray-100 pt-10">
              ...
              harum omnis sapiente recusandae magni neque dolorem quas soluta a
              hic! Nihil impedit, dolor voluptatem maiores veritatis tempora
              animi praesentium dolore, laudantium nisi suscipit quod sequi
              deleniti facere libero officia itaque sapiente tenetur molestiae
              temporibus officiis illo sed id enim. Atque ex eaque corrupti,
              fuga consectetur facere aut ipsa eligendi eos!
            </p>
          </div>
        </div>
        {/* {Tools Section} */}
        ...
        >
          ...
          <div className="bg-gray-600 lg:w-[500px] lg:h-[500px] w-full p-10">
            ...
            <p className="text-lg font-roboto text-gray-100 leading-8 pt-10">
              ...
              perspiciatis. Ratione cupiditate repellendus, ut exercitationem
              excepturi culpa quos, ducimus neque libero aperiam adipisci ab
              esse obcaecati mollitia dignissimos eius officiis perspiciatis
              corporis voluptate suscipit quia! Labore ab neque necessitatibus
              voluptate libero illum.
            </p>
          </div>
        </div>
        ...
        >
          <div className="bg-gray-600 lg:w-[500px] lg:h-[500px] w-full p-10">
            ...
            <p className="text-lg font-roboto text-gray-100 leading-8 pt-10">
              ...
              quasi tenetur? Similique praesentium hic numquam optio iure
              inventore placeat, ipsam corporis consequatur! Minima eum quis
              dolores reprehenderit? Harum ad ullam vitae tempore, saepe
              provident facilis nobis ducimus laboriosam adipisci laudantium sed
              quas laborum. Cum rem vel fuga aliquam reprehenderit nisi!
            </p>
          </div>
          <div>
            <img
          ...
          >
            <div>
              <h1 className="font-bold lg:text-3xl text-xl font-roboto text-gray-400">
                ...
                distinctio velit tenetur aliquam quia ipsum, saepe corrupti!"
              </h1>
            </div>
            <div className="py-6">
              <img
